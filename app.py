...
from utils.styling import (
    PRIMARY, PRIMARY_LIGHT, ACCENT, GOOD, BAD, MUTED, INK,
...
with n1:
    st.markdown('<div class="ps-nav-card">💰 <b>Pricing & Cost</b><br><span style="color:#5B6B79;font-size:0.85rem;">BOM waterfall, margin by scenario, payment structures</span></div>', unsafe_allow_html=True)
    st.page_link("pages/1_Pricing_and_Cost.py", label="Open", icon="➡️")
with n2:
    st.markdown('<div class="ps-nav-card">📈 <b>TCO & Payback</b><br><span style="color:#5B6B79;font-size:0.85rem;">24-month cost vs. PTFE/Viton and additives</span></div>', unsafe_allow_html=True)
    st.page_link("pages/2_TCO_and_Payback.py", label="Open", icon="➡️")
with n3:
    st.markdown('<div class="ps-nav-card">🔍 <b>Survey Explorer</b><br><span style="color:#5B6B79;font-size:0.85rem;">Full 1,200-respondent panel, live filters</span></div>', unsafe_allow_html=True)
    st.page_link("pages/3_Survey_Explorer.py", label="Open", icon="➡️")
with n4:
    st.markdown('<div class="ps-nav-card">🧮 <b>Scenario Modeling</b><br><span style="color:#5B6B79;font-size:0.85rem;">Stress-test price, cost and volume assumptions</span></div>', unsafe_allow_html=True)
